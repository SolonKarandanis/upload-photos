...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\AccountRepositoryInterface' => \App\Repositories\AccountRepository::class,
            'App\Repositories\PostRepositoryInterface' => \App\Repositories\PostRepository::class,
            'App\Repositories\TransactionRepositoryInterface' => \App\Repositories\TransactionRepository::class,
            'App\Repositories\TransferRepositoryInterface' => \App\Repositories\TransferRepository::class,
            'App\Repositories\UserRepositoryInterface' => \App\Repositories\UserRepository::class,
            'App\Services\AccountServiceInterface' => \App\Services\AccountService::class,
            'App\Services\PostServiceInterface' => \App\Services\PostService::class,
            'App\Services\TransactionServiceInterface' => \App\Services\TransactionService::class,
            'App\Services\TransferServiceInterface' => \App\Services\TransferService::class,
            'App\Services\UserServiceInterface' => \App\Services\UserService::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/solonk/4TB/Projects/upload-photos/upload-photos-back/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./home/solonk/4TB/Projects/upload-photos/upload-photos-back/public/storage','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'session.partitioned','concurrency.default','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify',
...
'broadcasting.connections.log.driver','broadcasting.connections.null.driver','tinker.commands','tinker.alias','tinker.dont_alias',);
        registerArgumentsSet('middleware', 
'web','api','auth','auth.basic','auth.session',
'cache.headers','can','guest','password.confirm','precognitive',
'signed','throttle','verified','verifyCategoryCount','has.set.pin',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie',
'image.index','image.store','image.destroy','categories.index','categories.store',
'categories.show','categories.update','categories.destroy','register',
