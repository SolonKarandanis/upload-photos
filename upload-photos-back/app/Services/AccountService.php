...
class AccountService implements AccountServiceInterface
{
    ...
    public function transfer(string $senderAccountNumber, string $receiverAccountNumber, string $senderAccountPin, float|int $amount, string $description = null): TransferDto
    {
